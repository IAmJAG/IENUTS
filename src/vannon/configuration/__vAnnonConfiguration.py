...
DB_CONFIG_PATH: str = "config/vannon/appconfig.json"


class vAnnonConfiguration(ApplicationConfiguration):
...
def LoadCFG(path: str = DB_CONFIG_PATH) -> vAnnonConfiguration:
    cfg: vAnnonConfiguration = vAnnonConfiguration()
...
Provider.RegisterFactory(iConfiguration, LoadCFG, vAnnonConfiguration, True)
